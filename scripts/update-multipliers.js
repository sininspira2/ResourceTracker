...
updates.forEach(update => {
  console.log(`UPDATE resources SET multiplier = ${update.multiplier} WHERE name = '${update.name}';`)
})

console.log('\n✅ Copy and paste these SQL statements into your database tool!')
console.log('🎉 Or run them through your preferred database management interface.') 