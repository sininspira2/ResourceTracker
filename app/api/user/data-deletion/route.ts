...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log(
      `GDPR Deletion Request: User ${userId} (with legacy IDs: ${oldUserIds.join(", ")}) requested data deletion. ${recordCount.length} records anonymized on ${new Date().toISOString()}`,
    );
