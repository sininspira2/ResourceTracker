...
export function NicknameSettings() {
  ...
  return (
    <div className="rounded-lg border border-border-primary bg-background-panel p-4 shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-lg border border-border-info bg-background-info p-3">
          <div className="mb-1 flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-version-tag-text">
          ...
          <p className="mt-1 text-xs text-text-link">
            {session.user.discordNickname
        ...
        {/* Info */}
        <div className="rounded-lg bg-background-panel-inset p-3">
