...
export function NicknameSettings() {
  ...
  return (
    <div className="bg-background-panel border-border-primary rounded-lg border p-4 shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-background-info border-border-info rounded-lg border p-3">
          <div className="mb-1 flex items-center gap-2">
            ...
            <span className="text-version-tag-text text-sm font-medium">
          ...
          <p className="text-text-link mt-1 text-xs">
            {session.user.discordNickname
        ...
        {/* Info */}
        <div className="bg-background-panel-inset rounded-lg p-3">
