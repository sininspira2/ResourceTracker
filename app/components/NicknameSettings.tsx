...
export function NicknameSettings() {
  ...
  return (
    <div className="bg-background-panel rounded-lg shadow-sm p-4 border border-border-primary">
      ...
      <div className="space-y-3">
        ...
        <div className="p-3 bg-background-info border border-border-info rounded-lg">
          ...
          <p className="text-xs text-text-link mt-1">
            {session.user.discordNickname
        ...
        {/* Info */}
        <div className="p-3 bg-background-panel-inset rounded-lg">
